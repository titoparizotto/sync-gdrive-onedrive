...
class Logger:
    def __init__(self, log_file: str = "out.log", log_level: int = logging.INFO):
        """
        Inicializa o Logger.
        ...
        self.formatter = logging.Formatter(
            fmt= ConfigManager.get("app.logger.format"),
            datefmt= ConfigManager.get("app.logger.date_format")
        )
